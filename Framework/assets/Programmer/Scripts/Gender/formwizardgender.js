    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                var dataRow = { Gender: $('#GenderName').val() };
                $.ajax({
                    type: 'POST',
                    url: '../GenderManagement/AddGender',
                    data: dataRow,
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert(" Gender Added Successfully!", function () {
                                window.location.href = '../GenderManagement/Index';
                            });
                        }
                        else {
