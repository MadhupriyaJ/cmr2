    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                ...
                var dataRow = {
                    CountryName: $('#CountryName').val(), IsoCode: $('#IsoCode').val(),
                    IsoCurrency: $('#IsoCurrency').val(), GMT: $('select[name="GMT"] OPTION:selected').val(), Locale: $('#Locale').val()
                };
                $.ajax({
                    type: 'POST',
                    url: '../CountryManagment/AddCountry',
                    data: dataRow,
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert("Country added Successfully!", function () {
                                window.location.href = '../CountryManagment/Index';
                            });
                        }
                        else {
