    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                ...
                var dataRow = { City: $('#City').val(), State: $('select[name="State"] OPTION:selected').val() };
               
                $.ajax({
                    type: 'POST',
                    url: '../CityManagement/AddCity',
                    data: dataRow,
                    success: function (response) {
                      
                        if (response == 'True') {                         
                            bootbox.alert("City Added Successfully!", function () {
                                window.location.href = '../CityManagement/Index';
                            });
                        }
                        else {
