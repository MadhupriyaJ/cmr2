    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                var dataRow = { Language: $('#Language').val() };
                $.ajax({
                    type: 'POST',
                    url: '../LanguageManagement/AddLanguage',
                    data: dataRow,
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert("Language Added Successfully!", function () {
                                window.location.href = '../LanguageManagement/Index';
                            });
                        }
                        else {
