    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                var dataRow = { Salutation: $('#Name').val() };
                $.ajax({
                    type: 'POST',
                    url: '../SalutationManagement/AddSalutation',
                    data: dataRow,
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert("Salutation Added Successfully!", function () {
                                window.location.href = '../SalutationManagement/Index';
                            });
                        }
                        else {
