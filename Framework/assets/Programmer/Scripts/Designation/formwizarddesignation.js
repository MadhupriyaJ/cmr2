    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                var dataRow = { Designation: $('#DesignationName').val() };
                $.ajax({
                    type: 'POST',
                    url: '../DesignationManagement/AddDesignation',
                    data: dataRow,
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert("Designation Added Successfully!", function () {
                                window.location.href = '../DesignationManagement/Index';
                            });
                        }
                        else {
