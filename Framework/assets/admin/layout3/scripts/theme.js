...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            var color_ = (Itachi.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (Itachi.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", Itachi.getGlobalCssPath() + file + ".css");
