    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 .button-submit').click(function () {
                var dataRow = { StateName: $('#State').val(), Country: $('select[name="Country"] OPTION:selected').val() };
                $.ajax({
                    type: 'POST',
                    url: '../StateManagement/AddState',
                    data: dataRow,
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert("State Added Successfully!", function () {
                                window.location.href = '../StateManagement/Index';
                            });
                        }
                        else {
