var FormWizard = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $('#form_wizard_1 #location').change(function () {
               var dataRow = { LocationName: $('#location').val() };
                $.ajax({
                    type: "POST",
                    url: '../../LocationManagement/GetLatitudeLongitude',
                    data: dataRow,
            ...
            $('#form_wizard_1 .button-submit').click(function () {             
                var dataRow = { Location: $('#location').val(), GeoLocation: $('#GeoLocation').val(),Latittude: $('#Latitude').val(), Longitude: $('#Longitude').val() };
                $.ajax({
                    type: 'POST',
                    ...
                    success: function (response) {
                        if (response == 'True') {
                            bootbox.alert("Location Added Successfully!", function () {
                                window.location.href = '../LocationManagement/Index';
                            });
                        }
                        else {
